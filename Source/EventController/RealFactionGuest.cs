...
namespace EventController_rQP
{
    public class RealFactionGuest : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.CheckboxLabeled("Alternate factions which has same pawn race (Deafault: True)".Translate(), ref RealFactionGuestSettings.alternativeFaction, "Factions with same pawn race will be alternative. (not xenotype, only main race concerned)".Translate());
